# GN-183 Waypoint v0.1.0

First release of GN-183 Waypoint. An NMEA 0183 debugger that reads from a serial port, a TCP
...
GN-183 Waypoint is MIT licensed. The terminal basemap draws vector tiles from
